...
若平面与原点的距离为$p$,且法向量为$\vec{n}_0=(\cos\alpha,\cos\beta,\cos\gamma) ,$则该平面方程为：
...
设$\vec{r}_0=(x_0,y_0,z_0),\vec{v}=(v_1,v_2,v_3) ,$则过点$P_0(x_0,y_0,z_0) $且与向量$\vec{v} $平行的直线方程为：
$$
...
思路：已经有了平面$4x-y+z=1 $,自然考虑到用交面式表达投影直线，如此的话只需要再求出过$L$且垂直于平面$4x-y+z=1$的平面即可.两平面垂直等价于法向量垂直.
...
$$
\pi_1=\pi_2\Longleftrightarrow 
$$
$$
\pi_1\parallel\pi_2,\pi_1\neq\pi_2\Longleftrightarrow 
\frac{}{}
$$
### 三平面关系

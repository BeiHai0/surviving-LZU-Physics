...
=\frac{\partial z}{\partial x}\frac{\partial x}{\partial x}+\frac{\partial z}{\partial y}\frac{\partial y}{\partial x}
=\frac{\partial z}{\partial x}
$$
...
2.设$z=f(x,y),y=g(x) $求$\frac{\partial z}{\partial x} $：此时$x,y$不独立,不能简单地像1中一样把$y$当常数对$x$求导，而要利用求复合偏导的方法：
